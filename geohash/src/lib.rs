...
pub fn bounding_box_int_with_precision(hash: u64, bits: usize) -> Box {
    ...
    println!("lat_int, lng_int: {} {}", lat_int, lng_int);
...
// fn main() {
//     let lat: f64 = -37.82341;
//     let lng: f64 = 144.98905;
//     let hash_c = encode_int(lat, lng);
//     println!("{}", hash_c.clone());
//     println!("{:b}", hash_c.clone());
//     let (decode_lat, decode_lng) = decode_int(hash_c);
//     println!("({}, {})", decode_lat, decode_lng);
// }
